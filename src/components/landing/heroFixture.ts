...
export const HERO_KANDIDAT: AutoFinderKandidat = {
  ...
  generation: 'F40',
  motor: '118i',
  motor_hergeleitet: false,
  baujahr_von: 2019,
  baujahr_bis: null,
  generation_baujahr_von: 2019,
  generation_baujahr_bis: null,
  leistung_ps: 140,
  kraftstoff: 'Benzin',
  // Die Karte zeigt die KONKRETE empfohlene Ausprägung, nicht die
  // Angebotsliste der Baureihe — deshalb hier genau ein Getriebe und genau
  // eine Karosserie, so wie die echte Antwort sie liefert.
  getriebe: ['automatik'],
  getriebe_verfuegbar: ['automatik', 'manuell'],
  getriebe_konkret: true,
  antrieb: 'Front',
  karosserie: ['kompakt'],
  karosserie_verfuegbar: ['kompakt'],
  karosserie_konkret: true,
  karosserie_quelle: 'baureihe_eindeutig',
  match_score: 8.5,
  datenqualitaet: 1.0,
  match_gruende: [],
  trade_offs: [],
